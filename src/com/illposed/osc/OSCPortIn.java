 ...
 *
 * Copyright (C) 2004, C. Ramakrishnan / Illposed Software All rights reserved.
 *
 ...
 *
 * receiver = new OSCPort(OSCPort.defaultSCOSCPort()); OSCListener listener =
 * new OSCListener() { public void acceptMessage(java.util.Date time, OSCMessage
 * message) { System.out.println("Message received!"); } };
 * receiver.addListener("/message/receiving", listener);
 * receiver.startListening();
 *
 * Then, using a program such as SuperCollider or sendOSC, send a message to
 * this computer, port 57110 (defaultSCOSCPort), with the address
 * /message/receiving
 */
