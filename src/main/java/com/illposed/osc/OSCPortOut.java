 ...
 * : OSCPort sender = new OSCPort(); Object args[] = new Object[2]; args[0] =
 * new Integer(3); args[1] = "hello"; OSCMessage msg = new
 * OSCMessage("/sayhello", args); try { sender.send(msg); } catch (Exception e)
