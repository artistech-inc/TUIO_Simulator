 ...
 * Its direct subclasses are: OscMessage, OscBundle
 *
 * Subclasses need to know how to produce a byte array in the format specified
 * by the OSC spec (or SuperCollider documentation, as the case may be).
 *
...
public abstract class OSCPacket {
     ...
     *
     * Subclasses should implement this method to product a byte array formatted
     * according to the OSC/SuperCollider specification.
     */
