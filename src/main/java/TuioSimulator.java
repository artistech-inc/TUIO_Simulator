...
public class TuioSimulator {
    ...
    public static void main(String[] argv) {
        ...
        final JCheckBoxMenuItem antialiasItem = new JCheckBoxMenuItem("Antialiasing", false);
        ...
        updateItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                if (updateItem.getState() == true) {
                    simulation.enablePeriodicMessages();
                } else {
                    simulation.disablePeriodicMessages();
                }
            }
        });
        ...
        angleItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
...
class AboutDialog extends JDialog {
    ...
    public AboutDialog() {
        ...
        Label headlineLabel = new Label("TUIO Simulator 1.4", Label.CENTER);
        ...
        Label copyrightLabel = new Label("(c) 2005-2009 Martin Kaltenbrunner", Label.CENTER);
        copyrightLabel.setBounds(5, 40, 280, 15);
        copyrightLabel.setBackground(Color.white);
        getContentPane().add(copyrightLabel);

        Label urlLabel = new Label("http://reactivision.sourceforge.net/", Label.CENTER);
